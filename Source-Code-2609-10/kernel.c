...
void error_3(void) {
    printf("\n-Error 3: Missing or insufficient arguements-");
}
...
void devlog(void) {
    printf("\n--Devlog--");
    printf("\n-Made the ASCII art more spaced out a bit-");
    printf("\n-Split some of the WarblerOS kernel.c code into functions-");
    printf("\n-Made the WarblerOS ASCII Art more colorful-");
}

void bugs(void) {
    printf("\n--Known Bugs For Build 2609.10--");
    printf("\n-Arrow keys count as number keys-");
    printf("\n-WarblerOS will not shut down on real hardware or unsupported hypervisors such as vmware-");
    printf("\n-If you overcrowd the screen too much, the cursor may get lost. If this happens, type the 'clear' command-");
}
        ...
        while (byte = scan()) {
            if (byte == 0x1c) {
                if (strlen(buff) > 0 && strcmp(buff, "exit") == 0) {
                    ...
                    printf("\n--About WarblerOS--");
                    printf("\n-WarblerOS Pre-Alpha Build 2609.10-");
                    ...
                    printf("\n-ascii: View the WarblerOS ASCII logo.");
                ...
                } else if (strlen(buff) > 0 && strcmp(buff, "ascii") == 0) {
                    print_ascii_art();         
                } else {
                    error_1();
                }
