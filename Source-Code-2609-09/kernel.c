        ...
        while (byte = scan()) {
            if (byte == 0x1c) {
                if (strlen(buff) > 0 && strcmp(buff, "exit") == 0) {
                    ...
                    printf("\n--About WarblerOS--");
                    printf("\n-WarblerOS Pre-Alpha Build 2609.09-");
                    ...
                    printf("\n--Devlog--");
                    printf("\n-Added an ASCII Art to WarblerOS that can be seen on boot or when the 'ascii' is typed-");
                    printf("\n-Fixed spelling error in the bug log-");
                } else if (strlen(buff) > 0 && strcmp(buff, "bugs") == 0) {
                    printf("\n--Known Bugs For Build 2609.09--");
